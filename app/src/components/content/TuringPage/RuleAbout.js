...
class RuleAbout extends React.Component {
  ...
  render() {
    ...
    const dataSource = [
      ...
      {title: '往期回顾', content: '从2014年举办第一届“图灵杯”程序设计大赛起，迄今已经成功地举办了四届，受到了全校热爱编程同学的欢迎，学生中的影响力越来越大。活动既突出专业特色又寓教于乐，不断提高学生的程序设计水平，在学生中形成了良好的科技创新氛围。比赛平台由ACM俱乐部技术部独立开发完成，组织运作也由ACM俱乐部组织协作开展。\n' +
